...
function Cheats()
	...
	elseif ReadByte(Save+0x3668) > 0 and ReadByte(Save+0x24FB) < 100 then -- Defense Boosts
	...
	elseif ReadByte(Save+0x3669) > 0 and ReadByte(Save+0x24F8) < 100 then -- AP Boosts
